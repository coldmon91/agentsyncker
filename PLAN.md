...
proman detect                        # 설치된 도구 목록 출력
proman backup --tool gemini          # 수동 백업
proman restore --tool gemini --backup gemini_GEMINI.md_20260302_143000.bak
proman sync --source gemini --target claude  # 역방향 동기화
```
